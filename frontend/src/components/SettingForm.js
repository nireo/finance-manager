...
const SettingForm = (props) => {
    ...
    const lowerCasedFirst = props.label[0].toLowerCase() + props.label.slice(1, props.label.length)
    return (
        <Form>
            <Form.Field onSubmit={props.update}>
                ...
                <p>After refreshing the page you should see your new {lowerCasedFirst}</p>
            </Form.Field>
        </Form>
    )
}
